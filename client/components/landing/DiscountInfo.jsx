...
const DiscountInfo = () => {
    return (
        <div className='container mx-auto flex flex-col items-center my-10 py-10 gap-y-5'>
            ...
            <h3 className='w-3/5 text-center text-md leading-7 text-[#6e6e6e]'>Subscribe to the TableShop mailing list to receive updates on new arrivals, special offers and other discount information.</h3>
            <form className='flex flex-col w-1/2 gap-y-10 items-center'>
